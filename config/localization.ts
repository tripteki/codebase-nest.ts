...
export default configNamespace ("localization", (): LocalizationOptions => ({
     ...
     * will be used when you are using translations in your application.
     */
    fallbackLang: process.env.APP_LOCALE || "en",
