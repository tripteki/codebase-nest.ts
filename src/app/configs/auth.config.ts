    ...
    */
    ...
    refreshOptions: {
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | JWT Session Refresh Time to Live
        |--------------------------------------------------------------------------
        |
        | Shorter refresh window when "remember me" is unchecked at login.
        | Defaults to 1 day (86400 seconds), aligned with Laravel session TTL.
        |
        */
        sessionRefreshExpiresIn: Number (process.env.JWT_SESSION_REFRESH_TTL || 86400),
    },
