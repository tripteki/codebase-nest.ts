...
export class UserAuthResetMailListener extends AppMailNotificationListener
{
    ...
    public async handle (event: UserAuthResetEvent): Promise<void>
    {
        this.mailService.sendMail ({
            ...
            to: event.email,
            subject: this.i18nService.t ("_module_v1_user.account_reset.subject"),
            context: {
                ...
                start_greeting: this.i18nService.t ("_module_v1_user.common.start_greeting", { args: { name: event.user.name, }, }),
                line1: this.i18nService.t ("_module_v1_user.account_reset.line1"),
                line2: this.i18nService.t ("_module_v1_user.account_reset.line2"),
                reset: this.i18nService.t ("_module_v1_user.account_reset.reset"),
                link: event.token,
            },
        });
    }
