        ...
        await this.notificationService.notify (
            { userId: event.userId, },
            {
                ...
                data: {
                    ...
                    message: this.i18nService.t ("_module_v1_user.import.completed.message", { args: { totalImported: event.totalImported, totalSkipped: event.totalSkipped, }, }),
                },
    ...
    public async handleFailed (event: UserAdminImportedFailedEvent): Promise<void>
    {
        await this.notificationService.notify (
            { userId: event.userId, },
            {
                ...
                data: {
                    filename: event.filename,
                    message: this.i18nService.t ("_module_v1_user.import.failed.message"),
                    error: event.error,
                },
            } as unknown as NotificationCreateValidatorDto
        );
