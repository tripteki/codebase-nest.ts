...
export class UserAuthRegisteredMailListener extends AppMailNotificationListener
{
    ...
    public async handle (event: UserAuthRegisteredEvent): Promise<void>
    {
        this.mailService.sendMail ({
            ...
            to: event.email,
            subject: this.i18nService.t ("_module_v1_user.account_registered.subject"),
            context: {
                close_greeting: this.i18nService.t ("_module_v1_user.common.close_greeting", { args: { appName: this.configService.get<string> ("app.name"), }, }),
                start_greeting: this.i18nService.t ("_module_v1_user.common.start_greeting", { args: { name: event.name, }, }),
                line1: this.i18nService.t ("_module_v1_user.account_registered.line1"),
                line2: this.i18nService.t ("_module_v1_user.account_registered.line2"),
                verify: this.i18nService.t ("_module_v1_user.account_registered.verify"),
