...
@Injectable ()
/**
 * @class {HttpVerificationGuard}
 * @implements {CanActivate}
 */
export class HttpVerificationGuard implements CanActivate
{
    /**
...
@Injectable ()
/**
 * @class {WsVerificationGuard}
 * @implements {CanActivate}
 */
export class WsVerificationGuard implements CanActivate
{
    /**
     * @param {ConfigService} configService
     * @param {UserAuthService} userAuthService
