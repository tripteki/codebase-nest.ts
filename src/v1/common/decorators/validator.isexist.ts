 ...
 */
export class CommonIsExistDecoratorValidator implements ValidatorConstraintInterface
{
    /**
    ...
    {
        return this.i18nService.t ("validation.exists", { args: { attribute: args.property, }, });
    }
}
 ...
 * @returns {Function}
 */
export function IsExist<T> (entityClass: EntityTarget<T>, validationOptions?: ValidationOptions): Function
{
    return (object: Record<string, any>, propertyName: string) =>
    {
        registerDecorator ({
            ...
            validator: CommonIsExistDecoratorValidator,
        });
    };
}
